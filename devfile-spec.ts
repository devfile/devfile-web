...
const typeMap: any = {
  DevfileSpec: o(
    [
      ...
      {
        json: 'starterProjects',
        js: 'starterProjects',
        typ: u(undefined, a(r('DevfileSpecStarterProject'))),
      },
  ...
  PurpleDockerfile: o(
    [
      ...
      {
        json: 'devfileRegistry',
        js: 'devfileRegistry',
        typ: u(undefined, r('PurpleDevfileRegistry')),
      },
  ...
  Parent: o(
    [
      ...
      { json: 'registryUrl', js: 'registryUrl', typ: u(undefined, '') },
      {
        json: 'starterProjects',
        js: 'starterProjects',
        typ: u(undefined, a(r('ParentStarterProject'))),
      },
      { json: 'uri', js: 'uri', typ: u(undefined, '') },
      { json: 'variables', js: 'variables', typ: u(undefined, m('')) },
      { json: 'version', js: 'version', typ: u(undefined, '') },
  ...
  FluffyDockerfile: o(
    [
      ...
      { json: 'buildContext', js: 'buildContext', typ: u(undefined, '') },
      {
        json: 'devfileRegistry',
        js: 'devfileRegistry',
        typ: u(undefined, r('FluffyDevfileRegistry')),
      },
  ...
  PurpleZip: o([{ json: 'location', js: 'location', typ: u(undefined, '') }], false),
  ...
  FluffyZip: o([{ json: 'location', js: 'location', typ: u(undefined, '') }], false),
  ...
  TentacledZip: o([{ json: 'location', js: 'location', typ: u(undefined, '') }], false),
  ...
  StickyZip: o([{ json: 'location', js: 'location', typ: u(undefined, '') }], false),
  Kind: ['build', 'debug', 'deploy', 'run', 'test'],
  Exposure: ['internal', 'none', 'public'],
