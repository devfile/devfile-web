...
import { DarkMode, Gradient, LightMode } from '../components';
import type { IconComponentProps } from '../components';

export function ThemingIcon(props: IconComponentProps): JSX.Element {
